...
const Home = () => {
  ...
  return (
    <div className="font-[Montserrat]">
      ...
      <section
        style={{ backgroundImage: "url(/images/bgs/media_background.svg)" }}
      ...
      <section
        style={{ backgroundImage: "url(/images/bgs/feedback_background.svg)" }}
        ...
        >
          ...
          <div className="card bg-[#258CCF] p-8 font-semibold text-white max-w-[28rem] animate-fade-in">
            ...
            <motion.p
              ...
              className="text-sm font-normal mt-4"
            >
              Volunteering fuels community growth. Grateful to the JHI for this
              honor and for enabling over 100 people to benefit from the medical
              outreach. Being a volunteer in this initiative has enhanced my
              ability to contribute to a healthier, more resilient community.
            </motion.p>
          </div>
          <div className="card bg-[#258CCF] p-8 font-semibold text-white max-w-[28rem] animate-fade-in">
            <motion.span
            ...
            >
              ...
              express my heartfelt gratitude to its founder. This initiative is
              not just about learning, it’s about building a community that
