      ...
      <section className="py-10 px-[2rem]">
        <article className="w-fit m-auto text-center flex flex-col items-center">
          ...
          <p className="font-[400] text-[1.125rem] leading-[1.9rem] text-[#333333] text-center mb-10 lg:max-w-[70rem] max-w-[20rem]">
            At JHI, every event is a story worth sharing. Explore highlights
            from past events and stay updated on upcoming opportunities. Be part
            of the journey, relive the moments, and create new ones!
          </p>
        ...
        {/* Render EventsList */}
        {activeTab === "photos" && (
          <EventsList events={eventsData.pastEvents} title="Past Events" />
        )}
        {activeTab === "videos" && (
          <EventsList events={eventsData.upcomingEvents} title="Upcoming Events" />
        )}
      </section>
    </>
  );
