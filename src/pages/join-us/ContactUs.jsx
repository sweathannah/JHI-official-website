      ...
      <section className="m-10 font-[Montserrat] mb-[7.5rem] bg-[#E5BF88]">
        <div className="w-full bg-[#D8C1A1]">
          <div className=" flex flex-col xl:flex-row  justify-between items-center w-full px-9 py-16 gap-8 max-w-[82.5rem] mx-auto">
            <div className="max-w-[40.7rem] text-white flex flex-col flex-1">
            ...
            <div className="w-[16.5rem] sm:w-[30rem] md:w-[40.7rem] flex flex-col justify-center items-center px-4 py-6 md:p-10 gap-6 h-[24rem] bg-white rounded-[1.25rem] flex-1">
              <input
                type="text"
              ...
              />
              <button className="text-white text-[1rem] leading-[1.25rem] font-bold bg-[#05175FBF] w-[5rem] p-2 rounded-lg mt-auto ">
                Submit
              </button>
            </div>
          </div>
        ...
        <div className="bg-[#E5BF88] max-w-[82.5rem] mx-auto">
          <h2 className="max-lg:text-center text-white text-h1 leading-[4.5rem] font-semibold p-8">
            Visit Our Social <br /> Media Page
          </h2>
          <div className="flex bg-inherit p-7 flex-col gap-10 max-lg:items-center">
            <div className="bg-white flex max-sm:flex-col  items-center px-6 py-7 rounded-[1.5rem] gap-4 max-w-[36rem]">
              <img className="max-sm:w-8 max-sm:h-8 sm:w-10 sm:h-10" src="/images/joinUsImg/instagram.png" alt="instagram" />
            ...
            <div className="bg-white flex max-sm:flex-col items-center px-6 py-7 rounded-[1.5rem] gap-4 lg:self-end max-w-[36rem] ">
              <img className="max-sm:w-8 max-sm:h-8 sm:w-10 sm:h-10" src="/images/joinUsImg/linkedIn.png" alt="instagram" />
              <p className="text-black font-bold text-[1rem] leading-[1.5rem] sm:text-[1.3rem] sm:leading-[1.8rem] lg:text-[1.8rem] lg:leading-[2.5rem] break-all">
                Jimoh Habibullahi Initiative
              </p>
            </div>
            <div className="bg-white flex max-sm:flex-col items-center px-6 py-7 rounded-[1.5rem] gap-4 max-w-[36rem]">
              <img className="max-sm:w-8 max-sm:h-8 sm:w-10 sm:h-10" src="/images/joinUsImg/twitter.png" alt="instagram" />
              <p className="text-black font-bold text-[1rem] leading-[1.5rem] sm:text-[1.3rem] sm:leading-[1.8rem] lg:text-[1.8rem] lg:leading-[2.5rem] break-all">
                Jimoh Habibullahi Initiative
              </p>
            </div>
            <div className="bg-white flex max-sm:flex-col items-center px-6 py-7 rounded-[1.5rem] gap-4 max-w-[36rem] lg:self-end">
              <img className="max-sm:w-8 max-sm:h-8 sm:w-10 sm:h-10" src="/images/joinUsImg/twitter.png" alt="instagram" />
              <p className="text-black font-bold text-[1rem] leading-[1.5rem] sm:text-[1.3rem] sm:leading-[1.8rem] lg:text-[1.8rem] lg:leading-[2.5rem] break-all">
                Jimoh Habibullahi Initiative
              </p>
            </div>
            <div className="bg-white  px-6 py-10 rounded-[1.5rem] gap-4  self-center">
